...
//        if(enablePrint) System.out.println("Root first child " + Tree1Root.getFirstChild().getValue());
...
//        if(enablePrint) System.out.println("Pre-Order traversal of tree S");
//        if(enablePrint) System.out.println(Arrays.toString(traverseIndexA.list.toArray()));
...
//        if(enablePrint) System.out.println("Pre-Order traversal of tree T");
//        if(enablePrint) System.out.println(Arrays.toString(traverseIndexB.list.toArray()));
...
//        }
        ...
        if(enablePrint) System.out.println("m = " + m + " n = " +  n);
...
//                System.out.println("LCS = " + lcs[i][j]);
                ...
                if((i > 0 && j > 0) && nodeListA.get(i - 1).isLeaf() && nodeListB.get(j - 1).isLeaf()) {
                    if(enablePrint) System.out.println("value = " + ((lcs[i][j] * 1.0)/(Math.sqrt(getDepth(nodeListA.get(i)) * getDepth(nodeListB.get(j))))));
...
//        }
        ...
        if(enablePrint) System.out.println("Sequences of Tree A: " + Arrays.toString(treeASeqs.toArray()));
        if(enablePrint) System.out.println("Sequences of Tree B: " + Arrays.toString(treeBSeqs.toArray()));
        ...
        if(enablePrint) {
            System.out.println("\ndLCS of sequences");
            if (enablePrint) printTable(dLCS, treeASeqs.size(), treeBSeqs.size());
        }
        ...
        long estimatedTimeInNanoSOurAlgo = System.nanoTime() - startTimeOurAlgo;
        long estimatedTimeInMilliSOurAlgo = TimeUnit.MILLISECONDS.convert(estimatedTimeInNanoSOurAlgo, TimeUnit.NANOSECONDS);
        System.out.println("Time taken to compute dLCS & dTED is " + Long.toString(estimatedTimeInNanoSOurAlgo) + " NanoSeconds");
        System.out.println("Time taken to compute dLCS & dTED is " + Long.toString(estimatedTimeInMilliSOurAlgo) + " MilliSeconds");
